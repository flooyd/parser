                    ...
                    if (e != null) {
                        ...
                        if (hero > 0) {
                            ...
                            for (Item item : entry.hero_inventory) {
                                    Entry constantItems = new Entry(time);
                                    constantItems.type = "CONSTANT_ITEM";
                                    constantItems.targetname = combatLogName;
                                    constantItems.valuename = item.id;
                                    constantItems.slot = entry.slot;
                                    constantItems.value = (entry.slot < 5 ? 0 : 123) + entry.slot;
                                    constantItems.itemslot = item.slot;
                                    constantItems.charges = item.num_charges;
                                    constantItems.secondary_charges = item.num_secondary_charges;
                                    output(constantItems);
                                }
